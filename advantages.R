...
sg1Adj <- 4974
sg2Adj <- (961+25)*(0.95) #961 vs 25 is Lisa's original adjacent vs non-adjacent split, but to just multiply by the freqs of sing vs plural would assume independence bet/ adjacency and number, which is wrong based on her sample. So I've added them together to re-estimate adjacent and non-adjacent from Lisa's sample-of-you freqs.
sg3Adj <- 1555
pl13Adj <- 637
pl2Adj <- (961+25)*(0.03)
DPsgAdj <- 1810
